...
#-Version
#
#   -Mice 1.4.0 01-NOV-2016 (EDW)
#
#      Update maci64 section for Xcode 8.0.
#
#   -Mice 1.3.0 12-AUG-2014 (EDW)
#
#      Update maci64 section for OS X 10.9.x, MATLAB 2014a, Xcode 5.1.1.
#
...
# target 10.12 
            ...
            CFLAGS="$CFLAGS -no-cpp-precomp -I$SPICE/include $GCC_WARNING"
            CLIBS=" $SPICE/lib/cspice.a  $MLIBS "
